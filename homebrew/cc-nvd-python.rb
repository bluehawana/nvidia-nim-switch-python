class CcNvdPython < Formula
  desc "Enhanced NVIDIA NIM proxy with dynamic model switching capabilities"
  homepage "https://github.com/yourusername/cc-nvd-python"
  url "https://github.com/yourusername/cc-nvd-python/archive/v1.0.0.tar.gz"
  ...
  def post_install
    ...
    config_dir = Pathname.new("~/.config/cc-nvd-python").expand_path
    config_dir.mkpath unless config_dir.exist?
  end

  def caveats
    <<~EOS
      🚀 cc-nvd-python (Claude Code - NVIDIA Dynamic) installed successfully!
